...
global nh nb rhc rbc rhelix rdh rcap ncap thcap dzb bturn brise dthb dsb dz dth ...
    ...
    lightblue navyblue forestgreen lawngreen;
...
shades = [cornflowerblue; shade_t2; shade_base];  % colors of chain a, chain b, base pairs
...
th1 = 20;               % starting rotation around nc1
x2 = x2b;       % end of coil
...
zp = [x1(3) .5*(x1(3)+x2(3))+10 x2(3)];
bctype = [1 1];
shades = [cornflowerblue*ones(nbase-1,1); lightgreen; shade_base];      % shades for coil and bases shades  
...
zp = [x1(3) x2(3)];
bctype = [1 1];
shades = [1*ones(nbase,1); shade_base];      % shades for coil and bases shades  
